...
namespace RemoveFiles
{
    ...
    class Command
    {
        ...
        public string ConnectionString
        {
            ...
            set
            {
                ...
                catch (Exception)
                {
                    ...
                    //TODO: Лучше выбросить исключение и позволить внешнему коду обработать его. Позволять какому-то произвольному классу завершать приложение - не лучшая практика.
                    Environment.Exit(0);
                }
            }
        }
        ...
        public void Help()
        {
            //TODO: Чтобы не писать кучу \n\t можно поставить перед строкой @ и сделать ее многострочной. Но это кому как удобнее.
